...
var engWordList = [
  ...
  [
    ...
    ["interestingly","inuteresuchinguri","イヌテレスチングリ","ぽてと"],
    ["warmly","warumuri","ワルムリ","ぽてと"],
    ["coldly","korudori","コルドリ","ぽてと"],
    ["commonly","kommonuri","コッモヌリ","ぽてと"],
    ["loosely","rusori","ルスリ","ぽてと"],
    ["loudly","raudori","ラウドリ","ぽてと"],
    ["quietly","kuwaietori","クワイエトリ","ぽてと"],
    ["openly","openori","オペノリ","ぽてと"],
    ["shakily","shekiri","シェキリ","ぽてと"],
    ["gracefully","gureshifuri","グレシフリ","ぽてと"],
    ["reluctantly","rerukuteringuri","レルクテリングリ","ぽてと"],
    ["uselessly","iusuresuri","イウスレスリ","ぽてと"],
    ["painfully","peinfuri","ペインフリ","ぽてと"],
    ["rightfully","raitofuri","ライトフリ","ぽてと"],
    ["nearly","niruri","ニルリ","ぽてと"],
    ["barely","beruri","ベルリ","ぽてと"],
    ["honestly","anesutori","アネストリ","ぽてと"],
    ["hungrily","hanguriri","ハングリリ","ぽてと"],
    ["abnormally","abunorumari","アブノルマリ","ぽてと"],
  ]
]
var sentenceTypes = [
  //hiragana
...
var wordList = [];
/*
rawWordList is a massive string directly taken from my excel spreadsheet list of japanese words
